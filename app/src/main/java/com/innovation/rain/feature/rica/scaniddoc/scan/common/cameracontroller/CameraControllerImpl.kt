...
class CameraControllerImpl @Inject constructor(private val context: Context,
    ...
    override fun setCameraCallback(cameraCallback: CameraCallback?) {
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@CameraControllerImpl.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@CameraControllerImpl.cameraDevice = null
        }

        override fun onError(cameraDevice: CameraDevice, error: Int) {
            onDisconnected(cameraDevice)
            cameraCallback?.onError(error.toString())
        }
    }
    ...
    private fun lockFocus() {
        ...
        file = File(context.getExternalFilesDir(null), "$timeStamp.jpg")
        try {
